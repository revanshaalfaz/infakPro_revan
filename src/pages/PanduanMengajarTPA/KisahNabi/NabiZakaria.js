      ...
      <div className="w-full min-h-screen bg-white overflow-y-auto" style={{ fontFamily: "poppins", overflowY: "scroll" }}>
        <div className="rounded-b-[40px] bg-[#0C8F8F] px-[24px]">
          ...
          <div className="flex flex-col items-center mt-[46px]">
            ...
            <p className="text-[25px] font-bold mb-[15px]">Zakaria</p>
          </div>
        </div>
        <div style={{ maxWidth: "90%", display: "block", margin: "20px" }}>
          <div className="flex justify-center items-center mt-[20px]">
            <img alt="" src="/images/nabizakariya.jpg" className="rounded-[20px]" />
          </div>
          <div className="text-center text-black mt-[20px]" style={{ lineHeight: "1.5" }}>
            <h1 style={{ fontSize: "23px", fontWeight: "bold" }}>Kisah Nabi Zakaria AS</h1>
            ...
            <p style={{ fontSize: "16px", textAlign: "justify", fontWeight: "medium", marginBottom: "100px" }}>
              Nabi Dzakaria merupakan keturunan Nabi Daud dan Nabi Sulaiman. Tak banyak kisah mengenai Nabi Dzakaria, namun menurut beberapa riwayat, Nabi Dzakaria juga memiliki sikap yang rendah hari dan selalu bersyukur kepada Allah.
